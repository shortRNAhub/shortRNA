setClass(
	...
	slots=representation(
		...
		allsrcs="data.frame",
		objvers="numeric"),
    prototype=prototype(description=NA_character_, alignStats=list(), agcounts=matrix(), agcounts_ambiguous=matrix(), agdef=data.frame(), norm=list(norm.factors=NA_real_, lib.sizes=NA_real_, cnq=NULL), allsrcs=data.frame(), composition=list(), rules=list(), creationDate=Sys.Date(), objvers=1),
