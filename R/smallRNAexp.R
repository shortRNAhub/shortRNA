...
#'
#' @return a smallRNAexp object.
#'
#' @export
smallRNAexp <- function(seqcounts, sources, phenoData, features2meta=NULL, description=NA_character_, rules=defaultAssignRules(), keepAllSrcs=TRUE){
    ...
    message("Processed input files, now creating smallRNAexp object...")
    o <- new("smallRNAexp", seqcounts=as.matrix(seqcounts), description=description, sources=sources, phenoData=phenoData, rules=rules)
...
#' getComposition
#'
#' Get the relative abundance of different types of RNAs populating a smallRNAexp dataset.
#'
#' @param o An object of class smallRNAexp
...
#' mergeSmallRNADatasets
#'
#' Merges two smallRNAexp objects.
#'
#' @param o1 An object of class smallRNAexp.
#' @param o2 An object of class smallRNAexp.
...
#'
#' @return An object of class smallRNAexp.
#'
#' @export
mergeSmallRNADatasets <- function(o1, o2, by="feature", ...){
