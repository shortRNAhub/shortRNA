...
subgraph 
rnaAln-->|voom/dupCor|rnaDiff[Differential analysis]
rnaAlnS-->|DEXSeq|rnaExon[Differential exon usage]
rnaDiff-->|fGSEA|rnaPath[Pathway analysis<br>KEGG, Reactome, GO]
...
subgraph 
shortAln-->|Statistical analysis|sRNA[shortRNA<br>our package]
end
...
subgraph 
atacAln-->|HMMRATAC|PC[Peak calling]
PC-->|csaw|daPC[Differential analysis]
daPC-->|VIPER|atacTF[TFBA]
